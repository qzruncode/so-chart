...
import type { BasePointChartInstance, Listeners, PointDataset } from '@so-chart/types/point';
...
export function bindListener(chart: BasePointChartInstance) {
  const { svg } = chart;
...
export function registerEvent(
  this: BasePointChartInstance,
  eventName: MouseEventName | ClickEventName,
  event: (exposedDatas: ExposedData[]) => void
) {
