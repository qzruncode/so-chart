import type { BaseBarChartInstance } from '@so-chart/types/bar';
import { getDomWidth } from '@so-chart/utils';

export function setSize(this: BaseBarChartInstance) {
...
export function setWidth(this: BaseBarChartInstance) {
