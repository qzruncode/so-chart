...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: {
      ...
      '@so-chart/basket': path.resolve(import.meta.dirname, 'packages/basket/src'),
      '@so-chart/fire': path.resolve(import.meta.dirname, 'packages/fire/src'),
      '@so-chart/fruit': path.resolve(import.meta.dirname, 'packages/fruit/src'),
      ...
      '@so-chart/table3d': path.resolve(import.meta.dirname, 'packages/table3d/src'),
